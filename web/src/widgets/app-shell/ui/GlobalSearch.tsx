    ...
    <form onSubmit={onSubmit} role="search" className="hidden max-w-md flex-1 sm:block">
      <div className="relative">
        ...
        <input
          ...
          className="h-10 w-full rounded-full border border-line-soft bg-surface pr-16 pl-10 text-sm text-fg outline-none transition-colors placeholder:text-faint hover:border-line focus:border-accent-strong"
        />
